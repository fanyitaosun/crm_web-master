<template>
  <div class="crm-update">
    ...
    <!-- 登录易优弹窗 -->
    <el-dialog :visible.sync="dialogVisible" title="登录易优账号" width="500px">
      <div slot="title" class="el-dialog__title">
        登录易优账号
        <p class="description">您可以登录易优账号来进行一键升级</p>
      </div>
      <!-- 登录表单 -->
      <el-form
        ref="loginRef"
      ...
      >
        <div class="form-item">
          <el-form-item prop="username">
            ...
            <el-input v-model="loginForm.username" placeholder="请输入您的易优账号"/>
          </el-form-item>
        </div>
        <div class="form-item password">
          <el-form-item prop="password">
            <i class="wk wk-lock"/>密码
            <el-input v-model="loginForm.password" type="password" placeholder="请输入您的易优账号的密码"/>
          </el-form-item>
        </div>
...
export default {
  ...
  data() {
    ...
    return {
      ...
      loginRules: {
        username: [
          { required: true, message: '请输入易优账号', trigger: 'blur' }
        ],
